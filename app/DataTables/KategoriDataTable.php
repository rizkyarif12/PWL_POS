...
class KategoriDataTable extends DataTable
{
    ...
    //         $button = '<a href="' . route('kategori.edit', $row->kategori_id) . ' " class="btn btn-warning">Edit</a>';
    //         $button .= '<a href="' . route('kategori.hapus', $row->kategori_id) . ' " class="btn btn-danger">Hapus</a>';
    //         return $button;
    //     })
    //     ->setRowId('id');
    // }
